...
require (
	...
	github.com/coreos/go-oidc v0.0.0-20171002155002-a93f71fdfe73 // indirect
	...
	golang.org/x/oauth2 v0.0.0-20180102150122-90155042cbc5 // indirect
	...
	gopkg.in/yaml.v2 v2.0.0-20180102123842-c95af922eae6 // indirect
